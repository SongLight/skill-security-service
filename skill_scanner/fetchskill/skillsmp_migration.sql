...
CREATE TABLE IF NOT EXISTS skillsmp_skill (
    ...
    sitemap_lastmod_utc TIMESTAMPTZ NULL,
...
ALTER TABLE skillsmp_skill
    ADD COLUMN IF NOT EXISTS sitemap_lastmod_utc TIMESTAMPTZ NULL,
    ADD COLUMN IF NOT EXISTS github_url TEXT NULL,
    ADD COLUMN IF NOT EXISTS github_owner TEXT NULL,
    ADD COLUMN IF NOT EXISTS github_repo TEXT NULL,
    ADD COLUMN IF NOT EXISTS github_branch TEXT NULL,
    ADD COLUMN IF NOT EXISTS github_path TEXT NULL,
    ADD COLUMN IF NOT EXISTS stars_count INTEGER NULL,
    ADD COLUMN IF NOT EXISTS forks_count INTEGER NULL,
...
ALTER TABLE skillsmp_skill
    DROP COLUMN IF EXISTS selected_latest,
    DROP COLUMN IF EXISTS selected_openclaw;
...
DROP INDEX IF EXISTS idx_skillsmp_skill_selected_latest;
DROP INDEX IF EXISTS idx_skillsmp_skill_selected_openclaw;
...
ALTER TABLE skillsmp_skill_artifact
    ADD COLUMN IF NOT EXISTS skillsmp_download_url TEXT NULL,
